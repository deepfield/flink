...
public class MergingWindowSetTest {
	 ...
	 */
	@Test
	public void testAddingIdenticalWindowsAfterMerge() throws Exception {
		@SuppressWarnings("unchecked")
		ListState<Tuple2<TimeWindow, TimeWindow>> mockState = mock(ListState.class);
		...
		assertTrue(mergeFunction.hasMerged());
		assertEquals(new TimeWindow(1, 2), windowSet.getStateWindow(new TimeWindow(1, 3)));

		// add new window that is identical the merged window
